...
class LayananMasyarakatAdapter :
    RecyclerView.Adapter<LayananMasyarakatAdapter.ListViewHolder>() {
    ...
    inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(items: Layanan) {
            with(itemView) {
                binding.hariLayanan.text = items.hari
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.item_informasi, parent, false)
